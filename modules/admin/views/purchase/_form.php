...
<div class="purchase-form">
    ...
    <?= $form->field($model, 'id_delivery')->dropDownList(\yii\helpers\ArrayHelper::map(\app\modules\admin\models\DeliveryAddress::find()->all(), 'id','name')) ?>

    <?= $form->field($model, 'id_card')->dropDownList(\yii\helpers\ArrayHelper::map(\app\modules\admin\models\BankCard::find()->all(), 'id','name')) ?>
